/*
generated at Tue May 14 00:15:05 2019
...
#define yyiexpr_NT 12
#define yysexpr_NT 13
#define yyiassign_NT 14
...
static short yynts_12[] = { yyiexpr_NT, 0 };
static short yynts_13[] = { yysexpr_NT, 0 };
static short yynts_14[] = { yyiassign_NT, yylval_NT, 0 };
static short yynts_15[] = { yyiexpr_NT, yyiexpr_NT, 0 };
static short yynts_16[] = { yylval_NT, 0 };
...
/* 16 */	"expr: CALL(ID,VOID)",
/* 17 */	"arguments: ARGS(NIL,expr)",
/* 18 */	"arguments: ARGS(arguments,expr)",
/* 19 */	"expr: iexpr",
/* 20 */	"expr: sexpr",
/* 21 */	"sexpr: STR",
/* 22 */	"iexpr: INT",
...
static void yyclosure_iexpr(NODEPTR_TYPE a, int c) {
	struct yystate *p = (struct yystate *)STATE_LABEL(a);
	yytrace(a, 23, c + 1, p->cost[yyiassign_NT]);
...
static void yylabel(NODEPTR_TYPE a, NODEPTR_TYPE u) {
	...
	case 257: /* INT */
		/* iexpr: INT */
		yytrace(a, 22, 1 + 0, p->cost[yyiexpr_NT]);
	...
	case 282: /* ATR */
		...
		c = ((struct yystate *)STATE_LABEL(LEFT_CHILD(a)))->cost[yyiassign_NT] + ((struct yystate *)STATE_LABEL(RIGHT_CHILD(a)))->cost[yylval_NT] + 1;
	...
	case 298: /* ARGS */
		...
		yytrace(a, 18, c + 0, p->cost[yyarguments_NT]);
		if (c + 0 < p->cost[yyarguments_NT]) {
			p->cost[yyarguments_NT] = c + 0;
...
static void yykids(NODEPTR_TYPE p, int eruleno, NODEPTR_TYPE kids[]) {
	...
	case 18: /* arguments: ARGS(arguments,expr) */
	...
	case 7: /* param: PARAM(tipo,ID) */
		kids[0] = LEFT_CHILD(p);
		break;
	case 17: /* arguments: ARGS(NIL,expr) */
